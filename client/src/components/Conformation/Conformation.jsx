        ...
        {status === "cancel" && (
          <div className="error">
            ...
            <div>
              ...
              <p>
                3. Account did not have sufficient funds to cover the
                transaction amount.
              </p>
              <p>
                4. The attempted transaction exceeds the withdrawal limit of the
                account.
              </p>
              <p>
                5. Card is expired. The customer will need to use a different
                card.
              </p>
            </div>
          </div>
